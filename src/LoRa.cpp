...
#define USE_DEBUG_OUTPUT 0 ///< Enable debug output

#define USE_DEBUG_CAD USE_EXPERIMENTAL_CAD ///< Enable CAD debug output

#define USE_ERRATA_CHECK 0 ///< Enable errata check
...
// registers
/// \todo review the register documentation. It was generated by copilot.
#define REG_FIFO 0x00
#define REG_OP_MODE 0x01       ///< Operating mode
#define REG_FRF_MSB 0x06       ///< MSB (most significant bytes) of frequency
#define REG_FRF_MID 0x07       ///< Middle byte of frequency
#define REG_FRF_LSB 0x08       ///< LSB (least significant byte) of frequency
#define REG_PA_CONFIG 0x09     ///< Power amplifier configuration
#define REG_OCP 0x0b           ///< Over current protection control
#define REG_LNA 0x0c           ///< LNA (Low Noise Amplifier) settings
#define REG_FIFO_ADDR_PTR 0x0d ///< FIFO SPI pointer
#define REG_FIFO_TX_BASE_ADDR 0x0e    ///< Start address of TX FIFO
#define REG_FIFO_RX_BASE_ADDR 0x0f    ///< Start address of RX FIFO
#define REG_FIFO_RX_CURRENT_ADDR 0x10 ///< Current address in RX FIFO
#define REG_IRQ_FLAGS 0x12            ///< Interrupt request flags
#define REG_RX_NB_BYTES 0x13          ///< Number of received bytes
#define REG_PKT_SNR_VALUE 0x19        ///< Packet SNR value
#define REG_PKT_RSSI_VALUE 0x1a       ///< Packet RSSI value
#define REG_RSSI_VALUE 0x1b           ///< Current RSSI value
#define REG_HOP_CHANNEL 0x1c          ///< Hop channel
#define REG_MODEM_CONFIG_1 0x1d       ///< Modem configuration
#define REG_MODEM_CONFIG_2 0x1e       ///< Modem configuration
#define REG_SYMB_TIMEOUT_MSG_MASK 0x3 ///< MSB in REG_MODEM_CONFIG_2 bits 1-0
...
#define REG_MODEM_CONFIG_3 0x26       ///< Modem configuration
#define REG_FREQ_ERROR_MSB 0x28       ///< Frequency error MSB
#define REG_FREQ_ERROR_MID 0x29       ///< Frequency error middle
#define REG_FREQ_ERROR_LSB 0x2a       ///< Frequency error LSB
#define REG_RSSI_WIDEBAND 0x2c        ///< RSSI wideband
#define REG_DETECTION_OPTIMIZE 0x31   ///< Detection optimize
#define REG_INVERTIQ 0x33             ///< Invert IQ
#define REG_HIGH_BW_OPTIMIZE_1 0x36   ///< High bandwidth optimize
#define REG_DETECTION_THRESHOLD 0x37  ///< Detection threshold
#define REG_SYNC_WORD 0x39            ///< Sync word
#define REG_HIGH_BW_OPTIMIZE_2 0x3a   ///< High bandwidth optimize
#define REG_INVERTIQ2 0x3b            ///< Invert IQ
#define REG_DIO_MAPPING_1 0x40        ///< DIO mapping
#define REG_VERSION 0x42              ///< Version
#define REG_PA_DAC 0x4d               ///< PA DAC
#define REG_AGC_Thresh3L_F 0x64       ///< AGC threshold 3 low frequency
#define REG_IF_FREQ_1 0x30            ///< Intermediate frequency
#define REG_IF_FREQ_2 0x2F            ///< Intermediate frequency
...
// modes
#define MODE_LONG_RANGE_MODE 0x80 ///< Long range mode
...
#define MODE_RX_SINGLE 0x06       ///< Single receive mode
#define MODE_CAD 0x07             ///< Channel activity detection mode
#define MODE_MASK 0x07            ///< Mask for mode bits

// PA config
#define PA_BOOST 0x80 ///< PA boost

// IRQ masks
#define IRQ_RX_TIMEOUT_MASK 0x80        ///< RX timeout
#define IRQ_RX_DONE_MASK 0x40           ///< Packet reception complete
#define IRQ_PAYLOAD_CRC_ERROR_MASK 0x20 ///< Payload CRC error
#define IRQ_VALID_HEADER_MASK 0x10      ///< Valid header received
#define IRQ_CAD_DONE_MASK 0x04          ///< CAD complete
#define IRQ_TX_DONE_MASK 0x08           ///< Packet transmission complete
#define IRQ_FhssChangeChannel_Mask 0x02 ///< FHSS change channel
#define IRQ_CAD_DETECTED_MASK 0x01      ///< CAD detected

#define CRC_ON_MASK 0x04         ///< CRC enable
#define CRC_ON_PAYLOAD_MASK 0x40 ///< CRC enable on payload
#define PLL_TIMEOUT 0x80         ///< PLL timeout

#define RF_MID_BAND_THRESHOLD 525E6 ///< Frequency threshold for HF band
#define RSSI_OFFSET_HF_PORT 157     ///< RSSI offset for HF port
#define RSSI_OFFSET_LF_PORT 164     ///< RSSI offset for LF port

#define MAX_PKT_LENGTH 255 ///< Maximum packet length

#if (ESP8266 || ESP32)
#define ISR_PREFIX ICACHE_RAM_ATTR ///< ISR prefix for ESP8266 and ESP32
#else
#define ISR_PREFIX ///< Prefix for ISR functions
#endif
